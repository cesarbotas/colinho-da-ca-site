...
import { cadastrarPet, atualizarPet, listarClientes, listarRacas, PortePet, PortePetLabel, type PetData, type ClienteData, type RacaData } from "@/lib/api";
...
const AdminPetForm = ({ pet, onVoltar }: AdminPetFormProps) => {
